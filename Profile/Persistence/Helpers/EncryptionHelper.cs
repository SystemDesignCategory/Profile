...
namespace Profile.Persistence.Helpers;

public static class EncryptionHelper
{
    //todo: get key from appSetting
    public static string Key = "ThisIsATestKeyForEncrypt";

    public static string Encrypt(string dataToEncrypt)
    {
        ArgumentNullException.ThrowIfNull(Key, "Invalid Encryption key");
